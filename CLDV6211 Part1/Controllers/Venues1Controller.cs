...
{
    public class Venues1Controller : Controller
    {
        private readonly EventEaseDbContext _context;

        public Venues1Controller(EventEaseDbContext context)
        {
            _context = context;
        }
